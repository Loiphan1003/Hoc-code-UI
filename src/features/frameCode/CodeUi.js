...
import { faChevronLeft, faCircleCheck, faCircleXmark, faSpinner, faCircle } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <div className={styles.content_body}>
            ...
            <div className={styles.header}>
                <FontAwesomeIcon className={styles.headerIcon} icon={faChevronLeft} />
